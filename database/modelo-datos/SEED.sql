...
/* ============================================================
   8.1) Permisos + Matriz Rol/Permiso (dinamica)
   ============================================================ */
;WITH src AS (
...
(
    ...
    1,                          -- id_centro_costo
    1,                          -- id_temporada
    '0',                        -- folio_numero (folio por defecto)
    '1900-01-01 00:00:00',      -- periodo_desde (rango enorme)
    '9999-12-31 23:59:59',      -- periodo_hasta (rango enorme)
    'ABIERTO',                  -- estado
    0,                          -- bloqueado
    NULL,                       -- fecha_cierre
    'N/A',                      -- resultado_cuadratura
    'Folio por defecto: asignado antes de cualquier cambio. Rango amplio para cobertura total.',
